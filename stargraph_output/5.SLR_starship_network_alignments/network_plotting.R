...
edges_jac = read.csv(file="/home/samuel/projects/biforme/stargraph_output/5.SLR_starship_network_alignments/stargraph.starships_SLRs.pairwise_jaccard.tsv", header=T, sep='\t')
nodes = read.csv(file="/home/samuel/projects/biforme/stargraph_output/5.SLR_starship_network_alignments/stargraph.starships_SLRs.metadata.tsv", header=T, sep='\t')
...
suppressMessages(suppressWarnings(ggsave("/home/samuel/projects/biforme/stargraph_output/5.SLR_starship_network_alignments/network_plotting.jaccard.png", plot = plot_jac, units = "in", height = 8, width = 14, limitsize = FALSE)))
suppressMessages(suppressWarnings(ggsave("/home/samuel/projects/biforme/stargraph_output/5.SLR_starship_network_alignments/network_plotting.jaccard.svg", plot = plot_jac, units = "in", height = 8, width = 14, limitsize = FALSE)))


################################################################
###now do the same but for the containment values
edges_cont = read.csv(file="/home/samuel/projects/biforme/stargraph_output/5.SLR_starship_network_alignments/stargraph.starships_SLRs.pairwise_containment.tsv", header=T, sep='\t')
#nodes = read.csv(file="/home/samuel/projects/biforme/stargraph_output/5.SLR_starship_network_alignments/stargraph.starships_SLRs.metadata.tsv", header=T, sep='\t')
...
suppressMessages(suppressWarnings(ggsave("/home/samuel/projects/biforme/stargraph_output/5.SLR_starship_network_alignments/network_plotting.containment.png", plot = plot_cont, units = "in", height = 8, width = 14, limitsize = FALSE)))
suppressMessages(suppressWarnings(ggsave("/home/samuel/projects/biforme/stargraph_output/5.SLR_starship_network_alignments/network_plotting.containment.svg", plot = plot_cont, units = "in", height = 8, width = 14, limitsize = FALSE)))
