...
bed=read.csv("/home/samuel/projects/biforme/stargraph_output/3.SLR_plots/cluster3.regions_plus_flank.plotting.bed", sep='\t', header=T)
...
SLRbed=read.csv("/home/samuel/projects/biforme/stargraph_output/3.SLR_plots/cluster3.SLRs.bed", sep='\t', header=T)
...
links=suppressMessages(suppressWarnings(read_links("/home/samuel/projects/biforme/stargraph_output/3.SLR_plots/cluster3.contigs.nucmer.paf")))
...
#suppressMessages(suppressWarnings(ggsave("/home/samuel/projects/biforme/stargraph_output/3.SLR_plots/cluster3.png", plot = plot, units = "in", height = heightFrac, width = widthFrac, limitsize = FALSE)))
suppressMessages(suppressWarnings(ggsave("/home/samuel/projects/biforme/stargraph_output/3.SLR_plots/cluster3.svg", plot = plot, units = "in", height = heightFrac, width = widthFrac, limitsize = FALSE)))
