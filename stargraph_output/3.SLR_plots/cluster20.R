...
bed=read.csv("/home/samuel/projects/biforme/stargraph_output/3.SLR_plots/cluster20.regions_plus_flank.plotting.bed", sep='\t', header=T)
...
SLRbed=read.csv("/home/samuel/projects/biforme/stargraph_output/3.SLR_plots/cluster20.SLRs.bed", sep='\t', header=T)
...
links=suppressMessages(suppressWarnings(read_links("/home/samuel/projects/biforme/stargraph_output/3.SLR_plots/cluster20.contigs.nucmer.paf")))
...
#suppressMessages(suppressWarnings(ggsave("/home/samuel/projects/biforme/stargraph_output/3.SLR_plots/cluster20.png", plot = plot, units = "in", height = heightFrac, width = widthFrac, limitsize = FALSE)))
suppressMessages(suppressWarnings(ggsave("/home/samuel/projects/biforme/stargraph_output/3.SLR_plots/cluster20.svg", plot = plot, units = "in", height = heightFrac, width = widthFrac, limitsize = FALSE)))
